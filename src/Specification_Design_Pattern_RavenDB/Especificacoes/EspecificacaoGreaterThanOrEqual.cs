...
{
    public class EspecificacaoGreaterThanOrEqual<T> : Especificacao<T>
    {
        private readonly string _nomePropriedade;
        private readonly object _valor;

        public EspecificacaoGreaterThanOrEqual(string nomePropriedade, string valor)
        {
        ...
        public override Expression<Func<T, bool>> ToExpression()
        {
            ...
            var maiorQue = Expression.GreaterThanOrEqual(propriedade, Expression.Convert(constante, propriedade.Type));
